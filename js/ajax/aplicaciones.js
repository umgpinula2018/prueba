        ...
        { 
            if( data.result )
            {
                ...
                $.each( data.records, function( index,value )
                {
                    ...
                    counter3 = value.descripcion;                
                    counter4 = value.visible == 0 ? '<center><i class="disabled glyphicon glyphicon-eye-close"></i></center>' : '<center><i class="enabled glyphicon glyphicon-eye-open"></i></center>';
                    counter5 = '<td>'+
                                    ...
                                    '<a style="margin-left: 5px;" class="btn btn-danger btn-xs btn-eliminar" href="#modal-eliminar" data-toggle="modal" data-idregistro="'+value.id+'"><i class="fa fa-trash-o "></i></a>'+
                                '</td>';
                    window.tablaAreas.row.add([counter1,counter2,counter3,counter4,counter5]).draw(false);
                });
